...
<h3>Register No. : 212224230193</h3>
<h3>Ex. No. : 04</h3>
...
## OUTPUT:
<img width="1142" height="702" alt="image" src="https://github.com/user-attachments/assets/c15f8fca-7440-4fa0-9e3b-a6b06650b1b5" />

<img width="1132" height="723" alt="image" src="https://github.com/user-attachments/assets/7985c962-d04b-45bd-beca-f1e2dea418ca" />


## RESULT:
unifmem2 is better than unifmem1 for GPU performance. unifmem2 reduces GPU kernel execution time from 76.84 ms to 60.82 ms, giving approximately a 21% improvement. It also reduces Host-to-Device Unified Memory transfers from 191 MB to 128 MB and transfer time from 30.76 ms to 19.54 ms. Although unifmem1 has faster CPU initialization and host execution, unifmem2 has significantly better GPU and memory-transfer performance.
